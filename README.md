...
- Integración sin llave directa (IUM 100% vacío): cascada exacto → fuzzy → componentes cubre ~27% de los PAs y ~32% de las solicitudes ([reports/metricas_integracion.json](reports/metricas_integracion.json), se recalcula con cada corrida); el "sin match" restante refleja el fenómeno mismo (vitales sin registro vigente).
